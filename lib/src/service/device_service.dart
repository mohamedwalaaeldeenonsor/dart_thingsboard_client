...
class DeviceService {
    ...
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        ...
        return response.data != null
            ? DeviceInfo.fromJson(response.data!)
            : null;
      },
      requestConfig: requestConfig,
    );
  ...
  Future<Device?> assignDeviceToEdge(String edgeId, String deviceId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.post<Map<String, dynamic>>(
  ...
  Future<Device?> unassignDeviceFromEdge(String edgeId, String deviceId,
      {RequestConfig? requestConfig}) async {
    return nullIfNotFound(
      (RequestConfig requestConfig) async {
        var response = await _tbClient.delete<Map<String, dynamic>>(
  ...
  Future<PageData<Device>> getEdgeDevices(String edgeId, PageLink pageLink,
      {String type = '', RequestConfig? requestConfig}) async {
    var queryParams = pageLink.toQueryParameters();
    queryParams['type'] = type;
    var response = await _tbClient.get<Map<String, dynamic>>(
